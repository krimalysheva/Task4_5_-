...
namespace DrawConveer
{
    public class DrawField
    {
        ...
        public void DrawBusStop(Conveer bs)
        {
            ...
            int i = 0;
            int dx = 0;
            if (bs.consignment.Count != 0)
            {
                List<IMechanic> passag = new List<IMechanic>(bs.consignment);
        ...
        private void DrawBus(Bus bus)
        {
            ...
            if (bus.Passengers != null)
            {
                ...
                List<IMechanic> passag = new List<IMechanic>(bus.Passengers);
                foreach (var passenger in passag)
                {
