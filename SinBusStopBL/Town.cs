...
namespace SinConveerBL
{
    public class Town
    {
        ...
        public List<Conveer> BusStops { get; set; }
        public List<Bus> Buses { get; set; }
        public List<IMechanic> Passengers { get; set; }
        ...
        public void AddPassenger()
        {
            ...
            IMechanic NewMan = new SimpleMan(stations);
            int index = rnd.Next(0, 3);
            BusStops[index].consignment.Add(NewMan);
        }
        ...
        public void RandomBusesAndPassengers()
        {
            ...
            foreach (var busstop in BusStops)
            {
                ...
                for (int i = 0; i < P; i++)
                {
                    ...
                    busstop.consignment[i].BusStop = busstop;
                }
            }
        }
